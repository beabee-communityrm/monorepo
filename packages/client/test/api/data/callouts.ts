import { 
  ...
  export const createTestCallout = (slug = "test-callout-" + Date.now()): CreateCalloutData => ({
    slug,
  ...
  export const createMinimalTestCallout = (slug = "minimal-test-callout-" + Date.now()): CreateCalloutData => ({
    slug,
    image: "https://placehold.co/150",
    starts: new Date(),
    expires: new Date(Date.now() + 1000 * 60 * 60 * 24 * 7),
...
export const createTestCalloutResponseAnswers = (slideId = "slide1"): CalloutResponseAnswersSlide => ({
  [slideId]: {
    name: "Test Name",
...
export const createMinimalTestCalloutResponseAnswers = (slideId = "slide1"): CalloutResponseAnswersSlide => ({
  [slideId]: {
    name: "Test Name"
  }
}); 
