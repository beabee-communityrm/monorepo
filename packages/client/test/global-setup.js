...
export default async () => {
  ...
  .withWaitStrategy('db', Wait.forLogMessage(/database system is ready to accept connections/))
  .withWaitStrategy('api_app', Wait.forLogMessage(/Server is ready and listening on port 3000/))
