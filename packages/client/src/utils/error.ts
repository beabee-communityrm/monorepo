import {
  ...
  type DuplicateIdErrorData,
  type DuplicateTagNameErrorData,
  type FileTooLargeErrorData,
  type FileUploadErrorData,
  type InternalServerErrorData,
  type InvalidCalloutResponseCode,
  type InvalidCalloutResponseErrorData,
  type InvalidRuleErrorData,
  type LOGIN_CODES,
  type NoPaymentMethodErrorData,
  ...
  type UnsupportedFileTypeErrorData,
