export const de = {
  "accountPage": {
    ...
    "mfa": {
      ...
      "enterCode": {
        "desc":
          "Geben Sie den Code ein, der in Ihrer Authentifizierungs-App angezeigt wird.",
        "title": "Überprüfung",
      },
      "modalTitle": "Aktivere 2-Faktor Authentifizierung",
      "result": {
        "invalidCode":
          "Der Code konnte nicht bestätigt werden. Bitte versuchen Sie es erneut oder kontaktieren Sie den Support.",
        "successful":
      ...
      "scan": {
        "desc":
          "Scannen Sie den unten stehenden QR-Code mit Ihrer Authentifizierungs-App.",
        "title": "QR-Code",
      },
      "secretInput": {
        "desc":
          "Alternativ können Sie den nachstehenden Code in Ihre Authenticator-App eingeben.",
        "label": "Secret",
      },
  ...
  "adminSettings": {
    "apikey": {
      "confirmCreate": {
        "text":
          "Bitte speichern Sie den folgenden Token. Er kann später NICHT wieder angezeigt werden.",
  ...
  "callout": {
    ...
    "form": {
      ...
      "submittingResponseError":
        "Es gab ein Problem bei der Übermittlung ihrer Antworten. Bitte versuchen Sie es erneut.",
    },
    "getStarted": "Starten",
  ...
  "contactOverview": {
    ...
    "security": {
      ...
      "mfa": {
        "desc":
          'Dieser Kontakt hat 2FA aktiviert. Klicken Sie auf "{ disableLabel }", um es zu deaktivieren.',
  ...
  "contribution": {
    ...
    "cancelDescription":
      "Wenn Sie jetzt kündigen, endet Ihre Mitgliedschaft am {date}.",
    ...
    "changeBankInfo":
      "Im nächsten Schritt können Sie Ihre neue Bankverbindung eingeben.",
    "contributing": "Sie zahlen",
    "contributionUpdateError":
      "Sie können Ihren Beitrag aktuell nicht ändern, weil eine Zahlung kurz bevorsteht.",
    "dueToRenew": "Ihre Mitgliedschaft wird am {renewalDate} erneuert.",
    "expired": "Ihre Mitgliedschaft ist ausgelaufen.",
    "expiredText":
      "Möchten Sie Ihre Mitgliedschaft verlängern? Selbst kleinste Beträge helfen uns und unserer Arbeit. Danke!",
    "hasPendingPayment": "Ihre Zahlung wird gerade verarbeitet.",
    "manualPayment":
      "Sie zahlen Ihren Beitrag aktuell via {source}. Indem Sie über unser Mitgliedersystem bezahlen, bekommen wir einen besseren Überblick, auf welche Beiträge wir uns monatlich verlassen können. Für Sie wird es außerdem einfacher, Ihren Beitrag jederzeit zu ändern.",
    ...
    "paymentSourceUpdateError":
      "Sie können Ihre Bankverbindung aktuell nicht ändern, weil eine Zahlung kurz bevorsteht.",
    "prorateDecreaseMessage":
      "Ihr Beitrag bleibt noch für 1 Monat gleich. | Ihr Beitrag bleibt noch für {n} Monaten gleich.",
    "prorateDecreaseMessageWillStart":
      "Der neue Beitrag wird am {renewalDate} zum ersten Mal eingezogen.",
    "prorateIncreaseMessage":
      "Ihre Mitgliedschaft mit dem oben angezeigten Beitrag läuft noch 1 Monat. | Ihre Mitgliedschaft mit dem oben angezeigten Beitrag läuft noch {n} Monaten.",
    "prorateIncreaseMessageOneOff":
      "Sie können aber eine Einmalzahlung in Höhe von {oneOffPayment} leisten um Ihre Mitgliedschaft sofort zu verlängern und den Beitrag zu erhöhen.",
    "prorateNoText":
      "Wählen Sie diese Option, bleibt Ihr Beitrag bis zum neuen Abrechnungszeitrarum gleich.",
    "prorateNoTitle": "Ändern Sie meinen Beitrag ab dem {renewalDate}.",
    "prorateYesText":
      "Wählen Sie diese Option, buchen wir eine Einmalzahlung in Höhe von {oneOffPayment} ab und Ihre Mitgliedschaft wird mit Ihrem neuen Beitrag sofort verlängert.",
    ...
    "willRenew":
      "Ihre Mitgliedschaft verlängert sich am {renewalDate} automatisch.",
    "willRenewWithNewAmount":
      "Ihre Mitgliedschaft verlängert sich am {renewalDate} automatisch. Ihr Beitrag ist dann {nextAmount}.",
  },
  "createCallout": {
    ...
    "steps": {
      ...
      "endMessage": {
        "inputs": {
          ...
          "title": {
            "help":
              "<p>Die Teilnehmenden sehen den <strong>Titel der Dankesnachricht</strong> wenn sie ihre Antworten abgeschickt haben.</p>\n",
  ...
  "forgotPassword": {
    "backToLogin": "Zurück zum Login",
    "description":
      "Bitte geben Sie Ihre E-Mail-Adresse ein. Wir schicken Ihnen die Anleitung zum Zurücksetzten Ihres Passworts.",
    "message":
      "Gibt es einen Account mit der E-Mail-Adresse {email}, bekommen Sie in Kürze eine Nachricht. Bitte schauen Sie in Ihren Posteingang und befolgen Sie die Anleitung in der E-Mail. Sollte die E-Mail nicht auftauchen, schauen Sie auch in ihrem Spamordner nach.",
  ...
  "form": {
    ...
    "errorMessages": {
      "api": {
        ...
        "invalid-token":
          "Der von Ihnen eingegebene 2FA Token ist nicht korrekt.",
        "login-failed": "Falsche Kombination von Passwort und E-Mail.",
        "mfa-token-required":
          "Bitte geben Sie den Code Ihrer Authentifizierungs-App ein.",
      },
      "generic":
        "Upps! Etwas ist schiefgelaufen. Bitte wenden Sie sich an den Support, sollte das erneut passieren.",
      "validation":
        "Es fehlt etwas! Bitte kontrollieren Sie die obigen Felder.",
    },
    "errors": {
      "address": {
        "required":
          "Dieses Feld wird benötigt, wenn Sie eine Adresse eintragen wollen.",
      },
      "addressLine1": {
      ...
      "file": {
        "rateLimited":
          "Hochladen fehlgeschlagen: Sie haben in zu kurzer Zeit zu viele Dateien hochgeladen. Bitte warten Sie ein paar Minuten, bevor Sie es erneut versuchen.",
        "tooBig":
  ...
  "join": {
    "absorbFeeForce":
      "Bei einem Beitrag von {amount}, müssen Sie die {fee} Transaktionskosten übernehmen.",
    "absorbFeeOptIn": "Ja, ich übernehme die {fee} Transaktionskosten.",
    "absorbFeeText":
      "Bei unserem Zahlungsdienstleister zahlen wir für jede einzelne Transaktion. Das heißt, wir erhalten weniger von Ihrem monatlichen Beitrag. Sie haben die Möglichkeit, die Kosten dafür für uns zu übernehmen. Möchten Sie das? Alternativ können Sie auch jährlich bezahlen.",
    "contribute": "Mit {contribution} unterstützen.",
    "errors": {
      "confirmEmail": {
        "message":
          "Fast geschafft! Wir müssen nur noch Ihre E-Mail-Adresse bestätigen, um fortzufahren.",
        "proceed":
          "Wir haben Ihnen eine E-Mail geschickt. Bitte klicken Sie auf den Bestätigung-Link, um fortzufahren.",
        "title": "E-Mail-Adresse bestätigen",
      },
      "failed": {
        "backToJoin": "Zurück zur Registrierung",
        "message":
          "Es gab ein Problem bei der Registrierung, unser Team wurde benachrichtigt. Bitte kontaktieren Sie uns, wenn das Problem weiterhin auftritt.",
  ...
  "joinPayment": {
    ...
    "note":
      "Sie können Ihre Zahlungsdaten jederzeit in Ihrem Nutzer-Account ändern und dort auch sehen, wie viel Sie in der Vergangenheit bereits gezahlt haben. ",
  ...
  "lostDevice": {
    "description":
      "Bitte geben Sie Ihre E-Mail-Adresse ein, und wir senden Ihnen Anweisungen zum Zurücksetzen Ihres 2FA.",
    "message":
      "Gibt es einen Account mit der E-Mail-Adresse {email}, bekommen Sie in Kürze eine Nachricht. Bitte schauen Sie in Ihren Posteingang und befolgen Sie die Anleitung in der E-Mail. Sollte die E-Mail nicht auftauchen, schauen Sie auch in ihrem Spamordner nach.",
    ...
    "steps": {
      "accountConfirmation": {
        ...
        "joinSurvey": {
          ...
          "text":
            "Als Teil des Anmeldeprozesses kannst du deine neuen Mitglieder einen kurzen Fragebogen ausfüllen lassen. Du kannst zum Beispiel zusätzliche Informationen abfragen oder in Erfahrung bringen, warum sie Mitglied geworden sind.",
          "textIntro":
  ...
  "resetDevice": {
    "description":
      "Geben Sie Ihr Passwort ein, um den 2FA-Schutz zurückzusetzen. Sobald Sie eingeloggt sind, können Sie ein neues Gerät einrichten.",
    "failed":
