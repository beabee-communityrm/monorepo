...
/**
 * Rate Limiter Service for managing in-memory rate limiting.
...
export class RateLimiterService {
   ...
   */
  static clearCache(options: { force?: boolean; dev?: boolean } = {}): void {
   ...
   */
  static getLimiters(options: RateLimitOptions): {
   ...
   */
  static generateKey(baseKey: string): string {
