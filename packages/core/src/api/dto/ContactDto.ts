...
import { GetPaginatedQuery, GetPaginatedRuleGroup } from "../dto/BaseDto";
import {
  GetContactProfileDto,
  UpdateContactProfileDto
} from "../dto/ContactProfileDto";
import { CreateContactRoleDto, GetContactRoleDto } from "../dto/ContactRoleDto";
import { GetContactTagDto } from "../dto/ContactTagDto";
