...
export class RemoveGiftMemberships1788528151186 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `UPDATE "contact" SET "contributionType"='Manual' WHERE "contributionType"='Gift'`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "gift_flow" ADD CONSTRAINT "FK_70cda2b5d560765e318bf3995b0" FOREIGN KEY ("gifteeId") REFERENCES "contact"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }
}
