...
export class AddSignupFlow1772461466485 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "signup_flow" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" TIMESTAMP NOT NULL DEFAULT now(), "email" character varying NOT NULL, "loginUrl" character varying NOT NULL, "setPasswordUrl" character varying NOT NULL, "confirmUrl" character varying NOT NULL, "paymentFlowId" uuid, "contactId" uuid, "passwordHash" character varying NOT NULL, "passwordSalt" character varying NOT NULL, "passwordIterations" integer NOT NULL DEFAULT '1000', "passwordTries" integer NOT NULL DEFAULT '0', CONSTRAINT "REL_6153d3160f5f810ad8ad3aecb8" UNIQUE ("paymentFlowId"), CONSTRAINT "PK_12fe06cd273880ec41635acd5f0" PRIMARY KEY ("id"))`
    );
