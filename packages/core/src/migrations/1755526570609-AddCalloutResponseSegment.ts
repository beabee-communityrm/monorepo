...
export class AddCalloutResponseSegment1755526570609 implements MigrationInterface {
  name = 'AddCalloutResponseSegment1755526570609';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "callout_response_segment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "ruleGroup" jsonb NOT NULL,  "calloutId" uuid, "order" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_f9b91c0e735eedc417235f085c8" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
