<template>
  <div class="flex-0 basis-menu overflow-x-hidden overflow-y-auto">
    <div class="mb-4">
      ...
      <div class="space-y-1">
        <button
          ...
          :key="section.id"
          class="w-full overflow-hidden rounded-md px-3 py-2 text-left font-semibold text-ellipsis whitespace-nowrap transition-colors"
          :class="
