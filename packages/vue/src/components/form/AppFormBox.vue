...
export interface AppFormBoxProps {
  /** The title of the form box */
  title?: string;
  /** The notification to display in the form box */
  notification?: AppNotificationProps;
  /** Help text displayed above the label */
  help?: string;
}

defineProps<AppFormBoxProps>();
</script>
