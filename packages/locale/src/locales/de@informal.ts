...
export const deInformal = {
  accountPage: {
    ...
    phoneInfo:
      "Mit der Angabe deiner Telefonnummer erklärst du dich damit einverstanden, telefonisch kontaktiert zu werden.",
    phoneInfoAdmin:
      "Du musst die Zustimmung der Person einholen, bevor du ihre Telefonnummer in das System eingibst.",
      ...
      titleAndImage: {
        inputs: {
          ...
          image: {
            ...
            label: "Titelbild",
            description:
              "Vergessen Sie nicht, nach dem Hochladen eines Bildes zu speichern!",
          },
          intro: {
          ...
          slug: {
            locked: {
              title:
                "Der Permalink ist gesperrt, weil der Callout bereits veröffentlicht wurde.",
              description: "",
            },
            boxTitle: "Permalink",
    ...
    steps: {
      accountConfirmation: {
        ...
        newsletter: {
          ...
          optInDisabled:
            "Der Text wird nicht genutzt, wenn die Newsletter-Gruppen sichtbar sind.",
  ...
  tagEditor: {
    ...
    confirmDelete: {
      text_contact:
        'Bist du sicher, dass du diesen Tag entfernen willst? Jeder Kontakt mit dem Tag "{tagName}" wird den Tag verlieren.',
      text_global:
        'Bist du sicher, dass du den Tag "{tagName}" entfernen willst?',
      text_response:
        'Bist du sicher, dass du diesen entfernen willst? Jede Antwort mit dem Tag "{tagName}" wird den Tag verlieren.',
      title: "Tag entfernen",
    },
    name: "Name",
  },
  ...
  notifications: {
    copy: {
      ...
      errorDesc:
        "Text konnte nicht in die Zwischenablage kopiert werden. Bitte versuchen Sie es erneut oder kopieren Sie manuell.",
    },
  },
} as const;
