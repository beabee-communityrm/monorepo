    ...
    <div class="relative mb-4">
      <ul class="mb-2 text-sm">
        <li
          ...
          :key="i"
          class="group relative -mx-4 gap-2 border-t-4 border-b border-white bg-main-5 px-4 pt-3 pb-5 first:border-t"
        >
          ...
          />
          <span
            class="absolute bottom-full left-1/2 z-10 -translate-x-1/2 translate-y-1/2 rounded bg-main-70 px-2 py-1 font-bold text-white uppercase group-first:hidden"
