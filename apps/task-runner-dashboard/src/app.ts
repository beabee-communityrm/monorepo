...
const TASK_RUNNER_DASHBOARD_PORT = Number(process.env.TASK_RUNNER_DASHBOARD_PORT) || 3004;
const TASK_RUNNER_DASHBOARD_ROUTE_PREFIX = process.env.TASK_RUNNER_DASHBOARD_ROUTE_PREFIX || '/';
...
const { addQueue, removeQueue, setQueues, replaceQueues, express } = createDashboard(taskRunnerQueueService, {
